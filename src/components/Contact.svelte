<section class="relative h-96 scroll-snap-y">
  <span id="contact" class="absolute" />
  <div class="h-10perc flex-center pt-4 lg:pt-12">
    <h5
      class="text-2xl lg:text-5xl font-semibold tracking-wide animate-bounce "
    >
      Let's Collaborate!
    </h5>
  </div>
  <div class="h-90perc flex justify-evenly items-center flex-wrap">
    ...
    <div class="w-1/2 h-1/2 lg:w-1/4 lg:h-full flex-center">
      ...
      >
        ...
        <p class="text-lg lg:text-2xl">Resume</p>
      </a>
    </div>
  </div>
</section>
